...
export class ChannelsController {
  ...
  @ApiOperation({
    ...
    description:
      'Partial update — only provided fields (name, description, picture) are changed.',
  })
  ...
  update(
    ...
    return session.channelsUpdateChannel(id, request);
  }
  ...
  @ApiOperation({
    ...
    description:
      'Fetches messages of a channel you own or follow. ' +
      'Use the `after` query param (server_id of the oldest returned message) to paginate.',
  })
  async getChannelMessages(
    ...
    return session.channelsGetChannelMessages(id, query);
  }
