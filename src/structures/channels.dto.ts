...
export class UpdateChannelRequest {
  ...
  @ApiProperty({
    required: false,
    description: 'New channel name. Omit to keep current.',
  ...
  @ApiProperty({
    required: false,
    description: 'New channel description. Omit to keep current.',
  ...
  @ApiProperty({
    required: false,
    description: 'New channel picture. Omit to keep current.',
    oneOf: [
      { $ref: getSchemaPath(RemoteFile) },
      { $ref: getSchemaPath(BinaryFile) },
    ],
...
export class GetChannelMessagesQuery {
  ...
  @ApiProperty({
    required: false,
    description:
      'Cursor: server_id of the oldest message from the previous page. Omit to get newest.',
    example: null,
  })
  after?: number;
}
